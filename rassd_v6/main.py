"""
SOURCE v3.2 — SaaS Veille Marchés Publics Maroc
...
async def do_scrape():
    ...
    try:
        ...
        State.log("═" * 48)
        State.log("  SOURCE Scraper v3.2 — Multi-Source")
...
async def lifespan(app: FastAPI):
    init_db()
    State.log(f"SOURCE v{cfg.APP_VERSION} | Multi-source: {'✅' if MULTI_OK else '❌'}")
...
async def forgot_post(req: Request, email: str = Form("")):
    ...
    if m:
        ...
        try:
            ...
            send_email(email, "Réinitialisation de votre mot de passe — SOURCE",
