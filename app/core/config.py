...
class Settings:
    ...
    PLANS: dict = field(default_factory=lambda: {
        "free":      {"name":"Gratuit",   "name_ar":"مجاني",    "price":0,   "limit":10,  "tg":False},
        "essentiel": {"name":"Essentiel", "name_ar":"أساسي",    "price":149, "limit":0,   "tg":True},
        "pro":       {"name":"Pro",       "name_ar":"احترافي",  "price":399, "limit":0,   "tg":True},
    })
